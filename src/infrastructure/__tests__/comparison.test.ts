...
import { makePropertyComparer, SortComparisonStrategy } from '../index'
...
describe('Testing makePropertyComparer function', () => {
  ...
  it('String case-insensitive comparison strategy.', () => {
    const comparer = makePropertyComparer(sortOnProperty, SortComparisonStrategy.StringCaseInsensitive)
